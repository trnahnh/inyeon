        ...
        >
          <MagneticButton className="w-full sm:w-auto">
            <motion.a
              ...
              whileTap={{ scale: 0.98 }}
              className="btn-white inline-flex items-center justify-center gap-2 px-5 sm:px-6 py-2.5 sm:py-3 text-xs sm:text-sm rounded-full transition-all w-full"
            >
          ...
          <MagneticButton className="w-full sm:w-auto">
            <motion.a
              ...
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              className="btn-ghost inline-flex items-center justify-center gap-2 text-xs sm:text-sm w-full"
            >
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-4">
            ...
            <a
              ...
              className="text-zinc-400 hover:text-white text-xs sm:text-sm transition-colors break-all"
            >
